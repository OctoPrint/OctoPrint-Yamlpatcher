...
plugin_identifier = "yamlpatcher"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_yamlpatcher"

# The plugin's human readable name. Can be overwritten within OctoPrint's internal data via __plugin_name__ in the
# plugin module
plugin_name = "OctoPrint-Yamlpatcher"
...
# module
plugin_description = """Helper for patching up yaml files"""
...
plugin_url = "https://github.com/OctoPrint/OctoPrint-Yamlpatcher"
